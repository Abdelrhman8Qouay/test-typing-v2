...
// ======================== Keyboard Interface ========================
export default class KeyboardI {
    ...
    static activeKeyboardKey(char_index, gameObj) {
        ...
        var currKeyElement = document.querySelector(`.keyboard .keyboard-row .keyboard-key.key[data-char="${KeyboardI.getKeyCode(gameObj.current_para_content[char_index])}"]`)
        ...
        if (currKeyElement) {
            ...
            if (
                (/[A-Z]/.test(gameObj.current_para_content[char_index]) ||
                    ...
                    /[ `!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/.test(gameObj.current_para_content[char_index])) &&
